...
function getDeclaredCollectionsForMap(playNode) {
    const declaredCollections = [];
    const collectionsPair = _.find(playNode === null || playNode === void 0 ? void 0 : playNode.items, (pair) => (0, yaml_1.isScalar)(pair.key) && pair.key.value === "collections");
    if (collectionsPair) {
...
function isPlayParam(path, fileUri) {
    var _a;
    const isAtRoot = ((_a = new AncestryBuilder(path).parentOfKey().parent(yaml_1.YAMLSeq).getPath()) === null || _a === void 0 ? void 0 : _a.length) === 1;
    if (isAtRoot) {
...
function getOrigRange(node) {
    ...
    if (node.range) {
        ...
        return [(_a = node === null || node === void 0 ? void 0 : node.range) === null || _a === void 0 ? void 0 : _a[0], (_b = node === null || node === void 0 ? void 0 : node.range) === null || _b === void 0 ? void 0 : _b[1]];
    }
}
...
function isCursorInsideJinjaBrackets(document, position, path) {
    const node = path === null || path === void 0 ? void 0 : path[(path === null || path === void 0 ? void 0 : path.length) - 1];
    let nodeObject;
    try {
